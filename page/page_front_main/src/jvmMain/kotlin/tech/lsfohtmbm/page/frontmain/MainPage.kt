...
fun HTML.mainPage() {
    defaultPage("Главная") {
        ...
        defaultText(
            """Я Владимир. В 2021 году я начал заниматься коммерческой разработкой Android-приложений.
                | В этом блоге я буду рассказывать о своем опыте разработки и применения связанных с ней технологий. 
                | Возможно в будущем добавиться что-то еще.
            """.trimMargin()
        )
